...
#text(size: 10pt)[
  ...
  - *Planetaire Mono Text* is a lightweight subset (no icons), so it is far smaller,
    and its web CSS now uses Regular/Bold Latin, Greek, and Cyrillic WOFF2 slices with
    optional Regular/Bold italics. Recommended for the web, where the WOFF2 stylesheet
