...
def generate_site(
    ...
    *,
    ...
    italics_css_name = _copy_if_exists(fonts_dir / "planetaire-mono-text-italics.css", output_dir)
    ...
    index.write_text(_render_index(version, css_name, italics_css_name, specimen_name, hero, demo))
    return index
...
def _render_index(
    version: str,
    css_name: str | None,
    italics_css_name: str | None,
    specimen_name: str | None,
    hero: str | None,
    demo: str | None,
) -> str:
    family = TEXT_FAMILY_NAME
    css_links = [f'<link rel="stylesheet" href="{css_name}">'] if css_name else []
    if italics_css_name:
